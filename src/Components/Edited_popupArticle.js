...
class Edited_popup extends React.Component {
  ...
  handleSubmit(
    ...
    formData.append(
      "ArticleIngress",
      this.state.articleIngress ? this.state.articleIngress : old_ingrss
    );
    formData.append(
      "CreatedBy",
      this.state.createdBy ? this.state.createdBy : old_created
    );
        ...
        <div className="edited__group">
          <div
            ...
            onClick={() => {
              ...
              this.setState({ Id: article.articleId });
            }}
          >
            <img src={article.articleImageName} alt="Product to show" />
            <span>{article.articleTitle}</span>
          </div>
          <div
            onClick={this.handleDelete.bind(this, article.articleId)}
              ...
              <div className="row__second">
                ...
                <div className="row__input">
                  <input
                    ...
                    id="ingress"
                    name="ingress"
                    placeholder={article.articleIngress}
                    autoComplete="false"
                    value={this.state.articleIngress}
                    onChange={this.handleIngress}
                  />
                </div>
              </div>
            </div>
