...
class Edited_popup extends React.Component {
  ...
  handleSubmit(
    ...
    formData.append(
      "ArticleParagraphImageName",
      this.state.imageName ? this.state.imageName : articleParagraphName
    );
    formData.append("ArticleParagraphImageFile", this.state.imageFile);
    formData.append(
      "Content",
      this.state.content ? this.state.content : old_content
    );
    formData.append("ArticleId", Number(article_id));
    axios
      .put("/api/ArticleParagraphs/" + articleParagraphId + "/", formData)
      .then((res) => {
  ...
  handleDelete(articleParagraphId) {
    axios
      .delete("/api/ArticleParagraphs/" + articleParagraphId + "/")
      .then((res) => {
      ...
      .catch(function (error) {
        // handle error
        alert(
          "We can't delete the Article correctly! because it includes some article paragraphs! delete the paragraphs first!! "
        );
        console.log(error);
      });
  }
        ...
        <div className="edited__group">
          <div
            ...
            onClick={() => {
              ...
              this.setState({ Id: paragraph.articleParagraphId });
            }}
          >
            <img
              src={paragraph.articleParagraphImageName}
              alt="Product to show"
            />
          ...
          <div
            onClick={this.handleDelete.bind(this, paragraph.articleParagraphId)}
        ...
        >
          <form
            ...
            onSubmit={this.handleSubmit.bind(
              this,
              paragraph.articleParagraphId,
              paragraph.articleParagraphImageName,
              paragraph.articleParagraphTitle,
              paragraph.articleId,
              paragraph.content
            )}
          >
              ...
              <div className="row__second">
                ...
                <div className="row__input">
                  <input
                    ...
                    id="title"
                    name="title"
                    placeholder={paragraph.articleParagraphTitle}
                    autoComplete="false"
